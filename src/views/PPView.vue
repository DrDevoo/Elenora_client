...
Nyilvántartási szám: 58034938  <br>
Adószám: 59982968-1-43  <br> <br>
...
Elérhetőség: https://www.rackhost.hu, info@rackhost.hu  <br> <br>

A WEBSHOP ÜZEMELTETÉSE SORÁN VÉGZETT ADATKEZELÉSEK LEÍRÁSA
A COOKIE-K HASZNÁLATÁVAL KAPCSOLATOS TÁJÉKOZTATÁS A weboldalon lévő sütik kezeléséről itt olvashatsz többet: Cookie használat 
A SZERZŐDÉSKÖTÉS ÉS TELJESÍTÉS ÉRDEKÉBEN KEZELT ADATOK A szerződéskötés és teljesítés érdekében több adatkezelési eset is megvalósulhat. Amennyiben a webshopon keresztül Ön nem vásárol és nem kezdeményez vásárlást, csak látogatója a webshopnak, akkor a marketing célú adatkezelésnél írtak vonatkozhatnak Önre. A szerződéskötés és teljesítés érdekében megvalósuló adatkezelések részletesebben: 
KAPCSOLATFELVÉTEL 
Például emailben, facebookon, instagramom vagy telefonon kérdéssel fordul hozzánk valamely termékkel kapcsolatban. Az előzetes kapcsolatfelvétel nem kötelező, ezt kihagyva is bármikor rendelhet a webshopból. 
...
Kezelt adatok: Az adatkezelés során az Adatkezelő az Ön nevét, lakcímét, telefonszámát, e-mail címét, a megvásárolt termék jellemzőit, a megrendelés számát és a vásárlás időpontját kezeli. Amennyiben Ön megadta a személyes adatait viszont még nem véglegesítette a rendelést, akkor a rendszer automatikusan két alkalommal emailt küld önnek melyben értesítést kap a rendelni kívánt termékek foglalásának a törléséről. Ha ezek után sem valósúl meg a megrendelés az adatokat töröljük. Amennyiben Ön rendelést adott le a webshopban, akkor az adatkezelés és az adatok megadása a szerződés teljesítéséhez elengedhetetlen. 
...
HÍRLEVÉL 
Kezelt adatok: Név, email cím, feliratkozás időpontja 
Az adatkezelés időtartama: A hírlevélről való leiratkozást követően az adatok törlésre kerülnek 
Az adatkezelés jogalapja: az információs önrendelkezési jogról és az információszabadságról szóló 2011. évi
CXII. törvény 5. § (1) bekezdés a) pontja alapján az érintett hozzájárulása 
A SZÁMLA KIÁLLÍTÁSA
...
Kezelt adatok: Név, cím, e-mail cím, telefonszám. Az adatkezelés időtartama: Az Adatkezelő az adatokat a
megrendelt áru kiszállításának időtartamáig kezeli. 
...
Amennyiben Ön garanciális ügyintézés kért, akkor az adatkezelés és az adatok megadása elengedhetetlen. 
...
A regisztráció,
megrendelés, hírlevélre történő feliratkozás során az informatikai rendszer eltárolja a hozzájárulással kapcsolatos informatikai adatokat a későbbi bizonyíthatóság érdekében. 
...
Az adatkezelés időtartama: Az adott cookie adattárolási idötartama, bővebb információ elérhető itt: Google általános cookie tájékoztatóGoogle Analitycs tájékoztatóFacebook tájékoztató 
...
végrehajtásában. Ennek során az Adatfeldolgozó az érintett számlázási nevét nevét és címét, a rendelés számát és időpontját a polgári jogi elévülési időn belül kezeli. 
...
A személyes adatokhoz való hozzáférés Ön jogosult arra, hogy az Adatkezelőtől visszajelzést kapjon arra vonatkozóan, hogy személyes adatainak kezelése folyamatban van-e, és ha adatkezelés folyamatban van, jogosult arra, hogy:
a kezelt személyes adatokhoz hozzáférést kapjon a következő információkról az Adatkezelő tájékoztassa az adatkezelés céljai
...
(azazjogos érdek) az adatkezelésre
a személyes adatokat Adatkezelő jogellenesen kezelte és ez a panasz alapján megállapítást nyert a személyes adatokat az Adatkezelőre alkalmazandó uniós vagy tagállami jogban előírt jogi kötelezettség teljesítéséhez törölni kell
...
arról, hogy a személyes adat szolgáltatása jogszabályon vagy szerződéses kötelezettségen alapul vagy szerződés kötésének előfeltétele-e, valamint hogy az Ön köteles-e a személyes adatokat megadni, továbbá hogy milyen lehetséges következményeikkel járhat az adatszolgáltatás elmaradása   az automatizált döntéshozatal tényéről (ha alkalmazott ilyen eljárás), ideértve a profilalkotást is, valamint legalább ezekben az esetekben az alkalmazott logikára és arra vonatkozóan érthető információkat, hogy az ilyen adatkezelés milyen jelentőséggel, és Önre nézve milyen várhatókövetkezményekkel bír.
