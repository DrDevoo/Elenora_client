...
1.	a) a szerződés teljesítéséért vállalt jótállás, amelyet a vállalkozás a szerződés megfelelő teljesítéséérta jogszabályi kötelezettségén túlmenően vagy annak hiányában önként vállal, valamint
...
PANASZÜGYINTÉZÉS ÉS JOGÉRVÉNYESÍTÉSI LEHETŐSÉGEK A fogyasztó a termékkel vagy az Eladó tevékenységével kapcsolatos fogyasztói kifogásait az alábbi elérhetőségeken terjesztheti elő: 
Telefon: +36 20 562 2510
Internet cím: https://www.elenora.hu/
E-mail: informacio@elenora.hu
...
fogyasztónak legkésőbb 15 napon belül - az írásbeli panaszra adott válaszra vonatkozó előírásoknak megfelelően - az érdemi válasszal egyidejűleg megküldeni. Egyebekben pedig az írásbeli panaszra vonatkozóan az alábbiak szerint köteles eljárni. Az írásbeli panaszt a vállalkozás - ha az Európai Unió közvetlenül alkalmazandó jogi aktusa eltérően nem rendelkezik - a beérkezését követően harminc napon belül köteles írásban érdemben megválaszolni és intézkedni annak közlése iránt. Ennél rövidebb határidőt jogszabály, hosszabb határidőt törvény állapíthat meg. A panaszt elutasító álláspontját a vállalkozás indokolni köteles. A telefonon vagy elektronikus hírközlési szolgáltatás felhasználásával közölt szóbeli panaszt a vállalkozás köteles egyedi azonosítószámmal ellátni. A panaszról felvett jegyzőkönyvnek tartalmaznia kell az alábbiakat: 
1.	a fogyasztó neve, lakcíme,
2.	a panasz előterjesztésének helye, ideje, módja,
3.	a fogyasztó panaszának részletes leírása, a fogyasztó által bemutatott iratok, dokumentumok ésegyéb bizonyítékok jegyzéke,
4.	a vállalkozás nyilatkozata a fogyasztó panaszával kapcsolatos álláspontjáról, amennyiben a panaszazonnali kivizsgálása lehetséges,
5.	a jegyzőkönyvet felvevő személy és - telefonon vagy egyéb elektronikus hírközlési szolgáltatásfelhasználásával közölt szóbeli panasz kivételével - a fogyasztó aláírása,
...
c.	ha a fogyasztó az illetékességet az illetékes békéltető testület helyett kérelmezett testületmegjelölését,
d.	a fogyasztó álláspontjának rövid leírását, az azt alátámasztó tényeket és azok bizonyítékait,
e.	a fogyasztó nyilatkozatát arról, hogy a fogyasztó az érintett vállalkozással közvetlenül megkísérelte avitás ügy rendezését
f.	a fogyasztó nyilatkozatát arra nézve, hogy az ügyben más békéltető testület eljárását nemkezdeményezte, közvetítői eljárás nem indult, keresetlevél beadására, illetve fizetési meghagyás kibocsátása iránti kérelemelőterjesztésére nem került sor, g. a testület döntésére irányuló indítványt,
...
Az egyes területileg illetékes Békéltető Testületek elérhetőségei: Baranya Megyei Békéltető Testület Cím: 7625 Pécs, Majorossy I. u. 36. 
...
SZERZŐI JOGOK 
A szerzői jogról szóló 1999. évi LXXVI. törvény (továbbiakban: Szjt.) 1. § (1) bekezdése értelmében a weboldal szerzői műnek minősül, így annak minden része szerzői jogi védelem alatt áll. Az Szjt. 16. § (1) bekezdése alapján tilos a weboldalon található grafikai és szoftveres megoldások, számítógépi programalkotások engedély nélküli felhasználása, illetve bármely olyan alkalmazás használata, amellyel a weboldal, vagy annak bármely része módosítható. A weboldalról és annak adatbázisából bármilyen anyagot átvenni a jogtulajdonos írásos hozzájárulása esetén is csak a  weboldalra való hivatkozással, forrás feltüntetésével lehet. A jogtulajdonos: Boros Csaba e.v. 
...
A weboldalon megjelenő adatokat szolgáltató szerverek elérhetősége évi 99,9% feletti. Rendszeresen mentés készül a teljes adattartalomról, így probléma esetén az eredeti adattartalom visszaállítható.A weboldalon  megjelenő adatokat Postgres adatbázisban tároljuk. Az érzékeny adatok megfelelő erősségű titkosítással vannak tárolva, kódolásukhoz processzorba épített hardveres támogatást használunk. 
A TERMÉKEK LÉNYEGES TULAJDONSÁGAIRA VONATKOZÓ TÁJÉKOZTATÁS 
A honlapon a megvásárolható termékek lényeges tulajdonságairól az egyes termékeknél szereplő leírásokban adunk tájékoztatást. Önnek a megrendelés során a megrendelés véglegesítése előtt folyamatosan lehetősége van az Ön által bevitt adatok módosítására (a böngészőben a vissza gombra kattintva az előző oldal nyílik meg, így akkor is javíthatóak a bevitt adatok, ha Ön már a következő oldalra lépett). Felhívjuk a figyelmét, hogy az Ön felelőssége, hogy az Ön által megadott adatok pontosan kerüljenek bevitelre, hiszen az Ön által megadott adatok alapján kerül számlázásra, illetve szállításra a termék. Ön a megrendelésével tudomásul veszi, hogy az Eladó jogosult az Ön hibás adatbeviteléből, a pontatlanul megadott adatokból eredő minden kárát és költségét Önre hárítani. Az Eladó a pontatlan adatbevitel alapján történő teljesítésért felelősségét kizárja. Felhívjuk a figyelmét arra, hogy a rosszul megadott e-mail cím vagy a postafiókhoz tartozó tárhely telítettsége a visszaigazolás kézbesítésének hiányát eredményezheti és meggátolhatja a szerződés létrejöttét. 
...
Fizetési módok A weboldalon az alább felsorolt fizetési módok közül lehet választani. A futárnál való fizetési mód választása esetén külön kezelési díjat számítunk fel, amelynek értéke 890 Ft.

Kártyás fizetés Stripe rendszerrel
Fizetés a futárnál 
Átvételi módok és díjak A szállítás kizárólag Magyarország területén lehetséges. Más országokba nem szállítunk! 

  GLS futárszolgálat: A csomag feladása utáni munkanapon 8 és 17 óra között viszi a futár a csomagot. A futár SMS-ben értesítést küld önnek a csomag feladásáról, illetve a kézbesítés előtt 1 órával ismét értesíteni fogja önt a futár. A GLS választásával lehetőség van a futárnál is fizetni utánvéttel, a számlázási adatoknál az utánvét fizetési mód kiválasztásával. A szállítás díja 1 990 Ft.
Teljesítési határidő A megrendelésre vonatkozóan az általános teljesítési határidő a rendelés visszaigazolásától számított legfeljebb 10 nap. Ez a szállítási határidő tájékoztató jellegű, az ettől történő eltérést minden esetben e-mail útján jelezzük. 
...
b)	több termék adásvételekor, ha az egyes termékek szolgáltatása eltérő időpontban történik,az utoljáraszolgáltatott terméknek, a fogyasztó vagy az általa megjelölt, a fuvarozótól eltérő harmadik személy általi átvételének napjától számított határidőn belül gyakorolhatja, mely határidő 14 nap. 
...
a)	a szolgáltatás nyújtására irányuló szerződés esetében a szolgáltatás egészének teljesítését követően, haa vállalkozás a teljesítést a fogyasztó kifejezett, előzetes beleegyezésével kezdte meg, és a fogyasztó tudomásul vette, hogy a szolgáltatás egészének teljesítését követően felmondási jogát elveszíti; 
b)	olyan termék vagy szolgáltatás tekintetében, amelynek ára, illetve díja a pénzpiac vállalkozás által nembefolyásolható, az elállási jog gyakorlására meghatározott határidő alatt is lehetséges ingadozásától függ; 
c)	olyan nem előre gyártott termék esetében, amelyet a fogyasztó utasítása alapján vagy kifejezett kéréséreállítottak elő, vagy olyan termék esetében, amelyet egyértelműen a fogyasztó személyére szabtak; d) romlandó vagy minőségét rövid ideig megőrző termék tekintetében; 
e)	olyan zárt csomagolású termék tekintetében, amely egészségvédelmi vagy higiéniai okokból az átadástkövető felbontása után nem küldhető vissza; 
f)	olyan termék tekintetében, amely jellegénél fogva az átadást követően elválaszthatatlanul vegyül mástermékkel; 
g)	olyan alkoholtartalmú ital tekintetében, amelynek tényleges értéke a vállalkozás által nem befolyásolhatómódon a piaci ingadozásoktól függ, és amelynek áráról a felek az adásvételi szerződés megkötésekor állapodtak meg, azonban a szerződés teljesítésére csak a megkötéstől számított harmincadik napot követően kerül sor; 
h)	olyan vállalkozási szerződés esetében, amelynél a vállalkozás a fogyasztó kifejezett kérésére keresi fel afogyasztót sürgős javítási vagy karbantartási munkálatok elvégzése céljából; 
i)	lezárt csomagolású hang-, illetve képfelvétel, valamint számítógépes szoftver példányának adásvételetekintetében, ha az átadást követően a fogyasztó a csomagolást felbontotta; 
...
Hibás teljesítés esetén az egyes tartós fogyasztási cikkekre vonatkozó kötelező jótállásról szóló 151/2003. (IX. 22.) Korm. rendelet  alapján az Eladó jótállásra köteles. Jogszabály írja elő a jótállás biztosítását az olyan tartós fogyasztási cikkek (pl.: műszaki cikkek, szerszámok, gépek) és alkatrészeik esetében, amelyek vásárlási értéke a 10 000 Ft-ot meghaladja. 
...
A jótállás a szavatossági jogok (termék és kellékszavatosság) mellett érvényesül, alapvető különbség az általános szavatossági jogok és a jótállás között, hogy a jótállás esetén a fogyasztónak kedvezőbb a bizonyítási teher. A 151/2003 Korm. Rendelet szerinti kötelező jótállás alá eső rögzített bekötésű, illetve a 10
kg-nál súlyosabb, vagy tömegközlekedési eszközön kézi csomagként nem szállítható fogyasztási cikket – a járművek kivételével – az üzemeltetés helyén kell megjavítani. Ha a kijavítás az üzemeltetés helyén nem végezhető el, a le- és felszerelésről, valamint az el- és visszaszállításról a vállalkozás, vagy – a
javítószolgálatnál közvetlenül érvényesített kijavítás iránti igény esetén – a javítószolgálat gondoskodik. Az eladó vállalása a kötelező jótállás időtartama alatt nem tartalmazhat a fogyasztóra nézve olyan feltételeket, amelyek hátrányosabbak azoknál a jogoknál, amelyeket a kötelező jótállás szabályai biztosítanak. Ezt követően (1 év után) azonban az önkéntes jótállás feltételei szabadon állapíthatóak meg, azonban a jótállás ebben az esetben sem érintheti a fogyasztó jogszabályból eredő -így köztük a kellékszavatosságon alapuló jogainak fennállását. 
