...
export default {
  ...
  mounted() {
    if (this.$route.query.c) {
      ...
      switch (c) {
        case "male":
          this.title = "Férfi karkötők";
          break;
        case "female":
          this.title = "Női karkötők";
          break;
        case "couple":
          this.title = "Páros karkötők";
          break;
        case "sales":
          this.title = "Kedvezményes karkötők";
          break;
        default:
          this.title = "Összes karkötő";
          break;
      }
    } else {
      this.title = "Összes karkötő";
...
<template>
  ...
  <main>
    ...
    <section class="s">
      <h1 class="picked-t">{{ this.title }}</h1>
